...
## J1/J2a/J2b1/J2b2a 收口与后续

J1 完成混合选择、活动子组和快照命令卡。J2a 完成混合 Control Group 与 Alt 抢组。J2b1 完成 Move、Attack Move、Rally 目标模式。J2b2a 已完成 Build 类型选择、正式预览与提交。以下留给 J2b2b：
