...
当前二进制版本为 Ability Catalog 19、Unit Command Log 9、Production Command
Log 16、Production Catalog 12、State Hash 43、Hot Snapshot 45、Replay Package 44。
...
与热快照哈希；第二项严格审计 801 条数据闭包、当前 47 条编译结果、JSON 法力、召唤
单位配置、复合挂点路径、双武器/目标层、
