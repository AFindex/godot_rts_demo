...
状态 Hash v2～v14 是历史移动至单位伤害边界。当前 Hash v15、Package v14、热快照 v14、Production Command Log v5、Construction Command Log v2 和 Unit Command Log v3 由 93 项全量回归验证；v15 新增建筑护甲、属性与防御升级量。
