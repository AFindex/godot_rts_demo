...
Replay Package v12 与热快照 v12 已保存采集、建造、生产、研究、建筑战斗和跨域工人任务未来态。Unit Command Log v3 使用独立 TargetUnit/TargetBuilding/TargetResourceNode；设施命令日志 v4 保存 Train/Cancel/Rally/Research/CancelResearch 的完整解析 Profile。研究等级、互斥组、队列和进度进入规范运行态。
