...
确定性基础设施在当前 Demo 范围内收口。Replay Package 尚未覆盖未来可能出现的单位生产/销毁、非矩形建筑、玩家经济或随机种子；这些应在对应玩法真正加入时扩展格式，而不是提前制造空字段。
...
当前状态 Hash v2 规范录像位于 `test_videos/20260711_113402/`、`test_videos/20260711_113232/` 和 `test_videos/20260711_115954/`；`20260711_114744/` 是持久化 codec 加入前的进程内热快照基线，更早三个目录保留为 v1 历史基线。
