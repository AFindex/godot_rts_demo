...
- `AiEncounterTelemetry` 每 30 Tick 消费比赛、经济、建筑、科技、AI 和 CombatEvent 快照，统计里程碑、攻击指令、实际命中、军队峰值/战损低点和科技等级，不把诊断写回策略或模拟。
- 双方完整基础设施 Tick 为 570/630，首次科技 750/870，自然扩张 1140/1260，首次攻击 780/750；最终累计科技 4/4、基地 2/2、攻击指令 62/83、实际命中 91/30、军队峰值到低点 14→1/3→1，比赛仍为 Running。
- 正式命令覆盖经济 27、建造 12、生产/研究 51、单位 174；Replay Package v17 规范往返成功。
- 99/99 全量黑盒回归通过。Release 256/512/1000 移动 P95 为 2.87/4.75/10.07ms；128/256 战斗 P95 为 3.06/3.18ms，全部通过预算。
