...
| S11 实际 RTS 玩法 | H3/J2b2b + S8-E5a 完成 | 双资源、建筑/生产/科技、扩张、视野/胜负、双 AI 持续遭遇战、完整操作与战斗、Package/Hot v17、Hash v18 | 后续能力由遭遇战关卡暴露的缺口驱动 |
...
- 修复 160×120 Town Hall 中心投递点不可达：DropOff 持久化按建筑尺寸派生的交互半径；双方完成采集循环 114/96 次。采矿去程/返程通过独立策略关闭单位碰撞，但仍受建筑和静态世界约束。
- 双方完整基础设施 Tick 为 570/630，首次科技 660/870，自然扩张 1140/1230，首次攻击 690/750；最终累计科技 4/4、基地 2/2、攻击指令 51/83、实际命中 84/30、军队峰值到低点 13→2/5→1，比赛仍为 Running。
- 正式命令覆盖经济 32、建造 12、生产/研究 54、单位 166；Replay Package/Hot Snapshot v18、State Hash v19 规范往返成功。
- 100/100 全量黑盒回归通过。Release 256/512/1000 移动 P95 为 1.48/4.96/9.45ms；128/256 战斗 P95 为 0.96/3.23ms，全部通过预算。
...
- 60 秒 AV1/WebM 位于 `test_videos/20260712_233934/`，32,562,443 字节、1802 帧，AV1/CRF32/preset8。
