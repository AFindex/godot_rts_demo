...
AI 宿主合同也已接入，但具体对局策略尚未完成。AI 只读 PlayerView、经济/基地/设施与比赛快照并输出高层意图，通过正式玩家命令执行；详细设计见 [RTS AI 架构](AI_ARCHITECTURE.md)。
...
- 模块化脚本 AI 驱动采集、建造、生产、研究、侦察和 AttackMove，形成可持续对局。（宿主架构已完成，策略待实现）
