...
SC2-C2/C3 工程闭环已推进：多单位施工让位、临时订单覆盖与恢复已经确定性实现；Hold/Harvest/敌军继续按保守策略等待 E0 实机证据，隐藏敌军仍等待 Detection/Visibility 合同，不把项目政策冒充成 SC2 已确认行为。
