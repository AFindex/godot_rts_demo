...
当前包含 81 个黑盒业务场景，并覆盖双资源经济、基地扩张/饱和度/工人转场、玩家视野/探索/命令权限、玩家能力/失败/终局、五类正式建筑、生产队列、多建筑生产前置、正式研究等级/取消/互斥、Ground/资源/友军 Rally 及其回放热恢复、版本化数据、建筑战斗、Clearance、动态地图、Portal/狭口、AttackMove、操作层、Replay Package、checkpoint 和热快照。
...
AI 宿主架构已完成：观察快照、版本化策略状态、错峰调度、有界意图和正式命令执行边界已落地，详见 [RTS AI 架构](docs/AI_ARCHITECTURE.md)。下一段实现模块化经济/建造/生产/侦察/战斗策略，形成可持续对局。
